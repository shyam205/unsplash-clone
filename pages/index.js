      ...
      <div className=' imagebox'>
        {
          ...
          <div className='imagesection-container' key={i}>
            <div className="imagesection">
              <Image src={`http://localhost:1337${photo.attributes.file.data.attributes.url}`} alt="main-image" layout='fill' />
...
export async function getStaticProps(){
  const res = await axios.get('http://localhost:1337/api/photos?populate=file');
